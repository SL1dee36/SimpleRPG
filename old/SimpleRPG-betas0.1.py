...
style.map('TButton', foreground=[('active', COLOR_TEXT), ('pressed', COLOR_TEXT)], background=[('active', "#2F4F4F"), ('pressed', "#66CDAA")])
style.configure('Start.TButton', padding=6, relief='flat', background=COLOR_BUTTON_START)
style.map('Start.TButton', foreground=[('active', COLOR_TEXT), ('pressed', COLOR_TEXT)], background=[('active', "#20B2AA"), ('pressed', "#66CDAA")])
style.configure('Attack.TButton', background=COLOR_BUTTON_ATTACK)
style.map('Attack.TButton', foreground=[('active', COLOR_TEXT), ('pressed', COLOR_TEXT)], background=[('active', "#2F4F4F"), ('pressed', "#66CDAA")])
